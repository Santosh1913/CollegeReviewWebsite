            ...
            <?php 
                ...
                { ?>
                    <tr>
                        ...
                        <td><a href="<?php echo $row['collweb']; ?>"><?php echo $row['collweb']; ?></td></a>


                      
                        <td><input type="button" value="Give Feedback" onclick="window.location='pubfeedback.php?collcode=<?php echo $row['collcode']; ?>'"></td>
